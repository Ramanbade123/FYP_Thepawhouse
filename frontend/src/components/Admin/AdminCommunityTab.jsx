...
const AdminCommunityTab = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-[#063630] to-[#085558] rounded-xl p-6 text-white">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h1 className="text-2xl font-bold">Lost & Found Management</h1>
            <p className="text-white/70 mt-1">Review, resolve, and moderate community reports</p>
          </div>
