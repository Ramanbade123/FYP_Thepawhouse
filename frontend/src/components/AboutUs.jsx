    ...
    <section className="py-24 px-4 relative overflow-hidden bg-gradient-to-b from-[#f7fdf9] to-white" ref={ref}>
      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        <motion.div
          ...
          className="mb-24"
        >
          <div className="bg-gradient-to-r from-[#008737] to-[#085558] rounded-3xl p-12 text-white">
            <div className="text-center mb-12">
              <Award className="h-12 w-12 text-white mx-auto mb-4" />
              <h2 className="text-3xl font-bold mb-4">Our Impact Across Nepal</h2>
              <p className="text-[#c6f7d9] max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { value: "2,500+", label: "Dogs Rescued", icon: "🐕" },
                { value: "1,800+", label: "Successful Adoptions", icon: "🏠" },
                { value: "8,000+", label: "Vaccinations Administered", icon: "💉" },
                { value: "4,500+", label: "Sterilization Surgeries", icon: "⚕️" }
              ].map((stat, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <div className="text-[#c6f7d9]">{stat.label}</div>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <motion.div
          ...
          className="text-center"
        >
          <h2 className="text-3xl font-bold text-[#063630] mb-6">
            Join Our Mission
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg">
            Whether you're looking to adopt, volunteer, or support our work, 
            there's a place for you in The Paw House family.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/adopt">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-[#008737] to-[#085558] text-white px-10 py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Adopt a Dog
              </motion.button>
            </Link>
            <Link to="/volunteer">
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-[#008737] text-[#008737] px-10 py-4 rounded-2xl font-bold text-lg hover:bg-[#008737]/5 transition-all duration-300"
              >
                Volunteer With Us
              </motion.button>
            </Link>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-500 text-sm">
              The Paw House is a registered non-profit organization in Nepal. 
