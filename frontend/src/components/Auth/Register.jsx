    ...
    <div className="min-h-screen bg-gradient-to-br from-[#EDEDED] to-gray-100 flex items-center justify-center px-4 py-12">
      ...
      <button
        ...
        style={{
          ...
          color: '#063630', transition: 'all 0.2s', zIndex: 50,
        }}
        onMouseEnter={e => { e.currentTarget.style.borderColor = '#008737'; e.currentTarget.style.color = '#008737'; }}
        onMouseLeave={e => { e.currentTarget.style.borderColor = '#d1d5db'; e.currentTarget.style.color = '#063630'; }}
      >
