...
const AdopterMessagesTab = () => {
  ...
  useEffect(() => {
    ...
    pollRef.current = setInterval(() => fetchMessages(activeConvo._id, true), 3000);
  ...
  return (
    <div>
      ...
      <ConfirmDeleteModal 
        ...
        message="This action cannot be undone. All messages in this conversation will be permanently removed for both you and the rehomer."
      />
    </div>
  );
};
